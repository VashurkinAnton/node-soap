...
Client.prototype._invoke = function(method, args, location, callback, options, extraHeaders) {
  var self = this,
    ...
    xmlnsSoap = "xmlns:" + envelopeKey + "=\"https://web.archive.org/web/20240429101858if_/http://schemas.xmlsoap.org/soap/envelope/\"";
  ...
  if ((style === 'rpc')&& ( ( input.parts || input.name==="element" ) || args === null) ) {
    ...
    (method.inputSoap === 'encoded') && (encoding = 'soap:encodingStyle="https://web.archive.org/web/20240424000559if_/http://schemas.xmlsoap.org/soap/encoding/" ');
  } else {
